...
Quantumult X 可订阅 [JD_remove_ads.QX.snippet](https://raw.githubusercontent.com/zyxingdev/script/main/JD/JD_remove_ads.QX.snippet)。启用 Rewrite 与 MitM、安装并信任证书后，强制结束京东 App，清除已缓存的开屏广告，再重新打开。
